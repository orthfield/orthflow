...
function Onboarding({ step, setStep, answers, setAnswers, onDone }) {
  ...
  return (
    <>
      <div style={{ position: "absolute", inset: 0, display: "flex", flexDirection: "column", padding: "64px 16px 34px", background: ink, zIndex: 1 }}>
  ...
  return (
    <>
      ...
      <div style={{ position: "absolute", top: 128, left: 0, right: 0, bottom: 0, background: ink, borderTopLeftRadius: 30, borderTopRightRadius: 30, zIndex: 20, display: "flex", flexDirection: "column", overflow: "hidden", animation: sheetAnim(anim) }}>
        ...
        <div style={{ position: "absolute", bottom: 0, left: 0, right: 0, padding: "90px 16px 34px", background: BOTTOM_GRAD }}>
